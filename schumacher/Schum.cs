...
namespace schumacher
{
    internal class Schum
    {
        ...
        public Schum(DateTime date, string grandprix, int position, int laps, int points, string team, string status)
        {
            Date = date;
            Grandprix = grandprix;
            Position = position;
        ...
        public Schum(string beolvasottsor)
        {
