...
namespace WindowsFormsAppTagdij
{
    public partial class Form1 : Form
    {
        ...
        {
            MySqlConnectionStringBuilder sb = new MySqlConnectionStringBuilder(); //kapcsolat teremtés az sql-el
            sb.Clear();
            sb.Server = "localhost";
            sb.UserID = "root";
            sb.Password = "";
            sb.Database = "tagdij"; //adatbázis neve
            connection = new MySqlConnection(sb.ConnectionString); //kapcsolat kialakítása
        ...
        {
            // a beviteli mezőben lévő adatok ellenőrzése
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            if (listBox_tagok.SelectedIndex < 0)
            {
                MessageBox.Show("Nincs kiválasztva személy!");
                return;
            }
